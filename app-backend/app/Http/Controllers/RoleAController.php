<?php
//ZzZ:CREATE
// app/Http/Controllers/RoleAController.php
...
class RoleAController extends Controller
{
    public function dashboard(Request $request)
    {
        try {
            $data = collect([
                ['message' => 'Welcome to Role A dashboard!']
            ]);
            return $this->successResponse($data, 'Role A Dashboard Accessed');
        } catch (\Throwable $e) {
            \Log::error($e);
            return $this->errorResponse('Failed to access Role A dashboard.', $e);
        }
    }
